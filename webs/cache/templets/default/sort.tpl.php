...
<div class="loca">
    <div>
        ...
        <a href="<?php echo $sorturl?>"><?php echo $sortname?></a>  → 小说列表 
    </div>
</div>
<!-- 位置 结束 -->
<div class="spline"></div>
...
<div class="mainarea">
    <div id="update" class="btable update">
        <div class="title">
            <div class="ment">        
                <dt class="active">
                    <a class="store"><?php echo $sortname?>  → 小说列表</a>
                </dt>      
            </div>
        </div>
            ...
            <div class="px">
                ...
                <div class="fr">
                        <select name="selectchag" onchange="location.href=this.value;">
                            ...
                            <option value="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&page=<?php echo $page?>&orderbyid=0">默认排列</option>
                            <option value="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&page=<?php echo $page?>&orderbyid=1">总推荐排行</option>
                            <option value="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&page=<?php echo $page?>&orderbyid=2">总点击排行</option>
                            <option value="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&page=<?php echo $page?>&orderbyid=3">月点击排行</option>
                            <option value="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&page=<?php echo $page?>&orderbyid=4">周点击排行</option>
                            <option value="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&page=<?php echo $page?>&orderbyid=5">日点击排行</option>
                            <option value="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&page=<?php echo $page?>&orderbyid=6">总收藏排行</option>
                            <option value="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&page=<?php echo $page?>&orderbyid=7">按完成字数</option>
                            <option value="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&page=<?php echo $page?>&orderbyid=8">按更新时间</option>
                        </select>
                 </div>
            </div>
            </form>
...
?>
                ...
                <div class="bookpage">
                    ...
                    <div class="page" >                        
                        <a title="首页" href="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&orderbyid=<?php echo $orderbyid?>&page=1">首页</a>
<?php
if($page > 1){
?>
<a title="上一页" href="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&orderbyid=<?php echo $orderbyid?>&page=<?php echo $page-1?>">上一页</a>
<?php } ?>
<?php
for($i=1;$i<=$pageend;$i++){
?>
...
if($page < $pagec){
?>
<a title="下一页" href="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&orderbyid=<?php echo $orderbyid?>&page=<?php echo $page+1?>">下一页</a>
<?php } ?>
                        <a title="最后一页" href="<?php echo PT_SITEURL?><?php echo PT_FILENAME_SORT?>?sortid=<?php echo $sortid?>&orderbyid=<?php echo $orderbyid?>&page=<?php echo $pagec?>">末页</a> 

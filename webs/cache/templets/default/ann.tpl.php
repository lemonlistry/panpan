...
<div class="loca">
    <div>
        ...
        <strong>您的位置：</strong>
        <a href="<?php echo PT_SITEURL?>"><?php echo PT_SITENAME?></a> → 小说公告 
    </div>
</div>
<!-- 位置 结束 -->
<div class="spline"></div>
...
<div class="mainarea" style="background:#f4f9fb">
        ...
        <div id="news">
            ...
            <div class="newsfont">                
                出自：<a href="<?php echo PT_SITEURL?>" class="f66"><span><?php echo PT_SITEURL?></span></a>　
                时间：<span><?php echo $anndate?></span>
                发布：<span><?php echo $annwriter?></span>
            </div>
